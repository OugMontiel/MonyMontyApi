  ...
  validarCreacion() {
    return [
      ...
      body("categoria")
        ...
        .isObject()
        .withMessage("La categoría debe ser un objeto"),
      ...
      body("entidad")
        ...
        .isObject()
        .withMessage("La entidad debe ser un objeto"),
      ...
      body("divisa")
        .notEmpty()
        .withMessage("La divisa es obligatoria")
        .isObject()
        .withMessage("La divisa debe ser un objeto"),
    ...
    return [
      ...
      body().custom((body) => {
        if (body.ingreso && body.egreso) {
          throw new Error(
            "No puede actualizar a ingreso y egreso simultáneamente",
          );
        }
        return true;
      }),
